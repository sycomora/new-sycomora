<template>
  ...
  <div class="w-full h-screen flex justify-center items-center">
    <div class="flex flex-col items-center gap-5">
      <p class="font-bold text-7xl">Sabar dong!</p>
      <span class="w-full px-96 text-3xl">
        Momo dan Tim Sycomora bekerja siang malam lembur bagai quda untuk
        membuat website ini. Mohon dukungannya yaaa Teman Momo semua!
      </span>
      <span class="font-bold text-3xl">Much love, Momo</span>
    </div>
  </div>
</template>
